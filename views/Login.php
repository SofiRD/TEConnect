...
if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
    header("location: "); //Locacion del index en la computadora
...
<body>
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Don't have an account? <a href="Usuario.php">Sign up now</a>.</p>
        </form>
    </div>    
    <br><br><a href="TEConnect-master/index.html">Regresar</a>
</body>
</html>